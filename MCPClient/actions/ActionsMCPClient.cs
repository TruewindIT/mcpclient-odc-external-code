...
namespace MCPClient.actions
{
    public class ActionsMCPClient : InterfaceMCPClient
    {
        ...
        {         
            ...
            string textResult = toolResult.Content.First(c => c.Type == "text").Text;
            return textResult;
        ...
        /*
        public string GetToolsSTDIO(string serverUrl)
        {
            var clientTransport = new StdioClientTransport(new StdioClientTransportOptions
            {
                ...
                Command = "npx",
                //Command = "dotnet",
                Arguments = ["mcp-remote", serverUrl],
                //Arguments = [ "-y", "supergateway", "--sse", serverUrl]
                //Arguments = ["-y", serverUrl],
                //Command = serverUrl,
